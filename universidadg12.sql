...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2025 a las 01:57:29
...
--
-- Base de datos: `universidadg12`
--
CREATE DATABASE IF NOT EXISTS `universidadg12` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `universidadg12`;
...
CREATE TABLE `alumno` (
  ...
  `fechaNacimietno` date DEFAULT NULL,
